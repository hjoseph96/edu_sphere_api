...
class User < ApplicationRecord
  ...
  pg_search_scope :search, against: %i[first_name last_name email], using: { trigram: { threshold: 0.1 } }
  ...
  def generate_avatar
    ...
    avatar.attach(io: File.open(new_avatar_path), filename: "#{full_name.parameterize}_#{id}.png")
